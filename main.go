...
import (
	"encoding/json"
	"fmt"
	"github.com/example.com/education/sdkInit"
	"github.com/example.com/education/service"
	"github.com/example.com/education/web"
	"github.com/example.com/education/web/controller"
	"os"
)
...
func main() {
	...
	initInfo := &sdkInit.InitInfo{
		...
		ChannelID:     "mychannel",
		ChannelConfig: os.Getenv("GOPATH") + "/src/github.com/example.com/education/fixtures/first-network/channel-artifacts/channel.tx",
		...
		ChaincodePath:   "github.com/example.com/education/chaincode/",
		UserName:        "User1",
	}
